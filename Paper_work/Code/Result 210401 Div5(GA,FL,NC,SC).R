...
state <- "Georgia"
state.abbr1 <- "GA"
mydat.GA <- generate_data(state = state,
                       state.abbr = state.abbr1,
                       start.date = start.date,
                       end.date = end.date)
dim(mydat.GA$aggregate.state) # [1] 159  98

state <- "Florida"
state.abbr2 <- "FL"
mydat.FL <- generate_data(state = state,
                          state.abbr = state.abbr2,
                          start.date = start.date,
                          end.date = end.date)
dim(mydat.FL$aggregate.state) # [1] 67 98

state <- "North Carolina"
state.abbr3 <- "NC"
mydat.NC <- generate_data(state = state,
                          state.abbr = state.abbr3,
                          start.date = start.date,
                          end.date = end.date)
dim(mydat.NC$aggregate.state) # [1] 100  98

state <- "South Carolina"
state.abbr4 <- "SC"
mydat.SC <- generate_data(state = state,
                          state.abbr = state.abbr4,
                          start.date = start.date,
                          end.date = end.date)
dim(mydat.SC$aggregate.state) # [1] 46 98

# Combine datasets under Division 5
mydat.div5 = list()
mydat.div5$deaths.county = rbind(mydat.GA$deaths.county,mydat.FL$deaths.county,mydat.NC$deaths.county,mydat.SC$deaths.county)
mydat.div5$cum.deaths.county = rbind(mydat.GA$cum.deaths.county,mydat.FL$cum.deaths.county,
                                     mydat.NC$cum.deaths.county,mydat.SC$cum.deaths.county)
mydat.div5$aggregate.state   = rbind(mydat.GA$aggregate.state,mydat.FL$aggregate.state,
                                     mydat.NC$aggregate.state,mydat.SC$aggregate.state)
...
idx <- which(county.list %in% c(get.county("GA"),get.county("FL"),get.county("NC"),get.county("SC")))
mydat.div5$adj.mat <-  county.adj.mat[idx,idx]
...
state.abbr <- paste0(state.abbr1,state.abbr2,state.abbr3,state.abbr4)
################################################################################################################################
...
save.image(file=paste0(Sys.Date(),"_",state.abbr1,state.abbr2,state.abbr3,state.abbr4,"_resultv1_zinb_daily_with_offset.Rdata"))
...
save.image(file=paste0(Sys.Date(),"_",state.abbr1,state.abbr2,state.abbr3,state.abbr4,"_resultv3_zinb_daily_with_offset.Rdata"))
